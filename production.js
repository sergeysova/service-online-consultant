	...
	*/
	...
	var ListClients = function (_Component2) {
	  ...
	  function ListClients() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ListClients).apply(this, arguments));
	  }
	  ...
	  _createClass(ListClients, [{
	    ...
	    value: function render() {
	      var rows = [];
	      var lastUser = null;
	      this.props.users.users.forEach(function (el) {
	        rows.push(_react2.default.createElement(UserCol, { user: el, key: el.sid }));
	      });
	      return _react2.default.createElement(
	        "table",
	        null,
